 ...
 * Instead, change the Places/District.js file.
 *
 * @module Places
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Places', 'indexes', 'District'], false)) {
		return new Db.Expression((withoutDbName ? '' : '{{dbname}}.')+'{{prefix}}district');
	} else {
		var conn = Db.getConnection('Places');
		var prefix = conn.prefix || '';
		var tableName = prefix + 'district';
 ...
 * @type string
 */
Base.prototype.className = "Places_District";
...
return [["varchar","20","",false],false,"MUL",null];
};
 ...
 * @throws {Error} An exception is thrown if 'value' is not string or is exceedingly long
 */
Base.prototype.beforeSet_districtCode = function (value) {
		if (value == null) {
			value='';
		}
		if (value instanceof Db.Expression) return value;
		if (typeof value !== "string" && typeof value !== "number")
			throw new Error('Must pass a String to '+this.table()+".districtCode");
		if (typeof value === "string" && value.length > 40)
			throw new Error('Exceedingly long value being assigned to '+this.table()+".districtCode");
		return value;
};
	 ...
	 * @return {integer}
	 */
Base.prototype.maxSize_districtCode = function () {
	 ...
	 * @return {array} [[typeName, displayRange, modifiers, unsigned], isNull, key, default]
	 */
Base.column_districtCode = function () {

return [["varchar","40","",false],false,"",null];
};
...
Base.prototype.beforeSave = function (value) {
	...
	if (this.fields["districtCode"] == undefined && value["districtCode"] == undefined) {
		this.fields["districtCode"] = value["districtCode"] = "";
	}
