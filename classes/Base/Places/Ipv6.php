 ...
 * Instead, change the Places_Ipv6.php file.
 *
 * @module Places
 */
/**
 * Base class representing 'Ipv6' rows in the 'Places' database
 * @class Base_Places_Ipv6
 * @extends Db_Row
 *
 * @param {array} [$fields=array()] The fields values to initialize table row as 
 * an associative array of $column => $value pairs
 * @param {string} [$fields.ipMin] defaults to ""
 * @param {string} [$fields.ipMax] defaults to ""
 ...
 */
abstract class Base_Places_Ipv6 extends Db_Row
{
	/**
	 * @property $ipMin
	 * @type string
	...
	{
		if (class_exists('Q_Config') and Q_Config::get('Db', 'connections', 'Places', 'indexes', 'Ipv6', false)) {
			return new Db_Expression(($with_db_name ? '{{dbname}}.' : '').'{{prefix}}'.'ipv6');
		} else {
			$conn = Db::getConnection('Places');
  			$prefix = empty($conn['prefix']) ? '' : $conn['prefix'];
  			$table_name = $prefix . 'ipv6';
  			if (!$with_db_name)
  				return $table_name;
	...
	static function insertManyAndExecute($rows = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $rows,
			array_merge($options, array('className' => 'Places_Ipv6'))
		);
	}
