 ...
 * Instead, change the Places_Region.php file.
 *
 * @module Places
 */
/**
 * Base class representing 'Region' rows in the 'Places' database
 * @class Base_Places_Region
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Places_Region extends Db_Row
{
	/**
	 * @property $geonameId
	 * @type integer
	...
	{
		if (class_exists('Q_Config') and Q_Config::get('Db', 'connections', 'Places', 'indexes', 'Region', false)) {
			return new Db_Expression(($with_db_name ? '{{dbname}}.' : '').'{{prefix}}'.'region');
		} else {
	...
	static function insertManyAndExecute($rows = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $rows,
			array_merge($options, array('className' => 'Places_Region'))
		);
	}
...
return array (
  ...
  3 => NULL,
	...
	{
		$field_names = array('geonameId', 'countryCode', 'regionCode', 'englishName', 'localName');
		$result = $field_names;
