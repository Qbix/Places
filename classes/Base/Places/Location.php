 ...
 * Instead, change the Places_Location.php file.
 *
 * @module Places
 */
/**
 * Base class representing 'Location' rows in the 'Places' database
 * @class Base_Places_Location
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Places_Location extends Db_Row
{
	/**
	 * @property $geohash
	 * @type string
	...
	static function insertManyAndExecute($rows = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $rows,
			array_merge($options, array('className' => 'Places_Location'))
		);
	}
...
return array (
  ...
  3 => 'CURRENT_TIMESTAMP',
	...
	{
		$field_names = array('geohash', 'publisherId', 'streamName', 'insertedTime');
		$result = $field_names;
