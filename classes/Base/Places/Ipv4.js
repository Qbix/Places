 ...
 * Instead, change the Places/Ipv4.js file.
 *
 * @module Places
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Places', 'indexes', 'Ipv4'], false)) {
		return new Db.Expression((withoutDbName ? '' : '{{dbname}}.')+'{{prefix}}ipv4');
	} else {
		var conn = Db.getConnection('Places');
		var prefix = conn.prefix || '';
		var tableName = prefix + 'ipv4';
 ...
 * @type string
 */
Base.prototype.className = "Places_Ipv4";
